...
BASE_SYSTEM_SECTIONS = (
    ...
    (
        ...
        "3. Observation questions: use observed state and only asked fields. Player name/username, game mode, held item, weather/time/day, world difficulty, dimension, biome, coords, world spawn, health, block at/below feet, nearby blocks/mobs, safety are observations, not commands. If asked for a full/complete item/block/biome/dimension ID, preserve the exact namespace, e.g. minecraft:grass_block. No tools or unrelated details. For weather/time/day-only questions, do not mention safety, monsters, entities, difficulty, inventory, coordinates, or commands unless asked.\n"
